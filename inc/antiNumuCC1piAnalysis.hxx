...
class antiNumuCC1piAnalysis: public baseTrackerAnalysis {
 public:
  ...
  enum enumStandardMicroTrees_antiNumuCC1piAnalysis{
    ...
    selmu_bdt_pid_unweighted_mu_cc1pi,
    hmnt_bdt_pid_unweighted_pi_cc1pi,
   
    selmu_bdt_pid_mu_test1,
    selmu_bdt_pid_pi_test1,
    selmu_bdt_pid_p_test1,
    selmu_bdt_pid_e_test1,
    hmnt_bdt_pid_pi_test1,
   
    selmu_bdt_pid_mu_test2,
    selmu_bdt_pid_pi_test2,
    selmu_bdt_pid_p_test2,
    selmu_bdt_pid_e_test2,
    hmnt_bdt_pid_pi_test2,
   
    selmu_bdt_pid_mu_test3,
    selmu_bdt_pid_pi_test3,
    selmu_bdt_pid_p_test3,
    selmu_bdt_pid_e_test3,
    hmnt_bdt_pid_pi_test3,
   
    selmu_bdt_pid_mu_test4,
    selmu_bdt_pid_pi_test4,
    selmu_bdt_pid_p_test4,
    selmu_bdt_pid_e_test4,
    hmnt_bdt_pid_pi_test4,
   
    selmu_bdt_pid_mu_test5,
    selmu_bdt_pid_pi_test5,
    selmu_bdt_pid_p_test5,
    selmu_bdt_pid_e_test5,
    hmnt_bdt_pid_pi_test5,
