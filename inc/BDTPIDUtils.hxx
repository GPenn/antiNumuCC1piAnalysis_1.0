...
class BDTPIDmanager{
  ...
  protected:
    ...
    Float_t bdt_tpc_like_mu, bdt_tpc_like_e, bdt_tpc_like_p, bdt_tpc_like_pi, bdt_tpc2_dedx, bdt_tpc3_dedx, bdt_tpc_pullmu, bdt_tpc_pullpi, bdt_tpc_pullp, bdt_tpc_pulle;
