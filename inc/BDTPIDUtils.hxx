...
class BDTPIDmanager{
  ...
  std::vector<Float_t> GetBDTPIDVars(AnaTrackB* track, AnaTECALReconObject* localecalsegment, TString BDTname="BDTG_tree3");
  ...
  protected:
    ...
    Float_t bdt_tpc_like_mu, bdt_tpc_like_e, bdt_tpc_like_p, bdt_tpc_like_pi, bdt_tpc2_dedx, bdt_tpc3_dedx;
