...
launchscriptfile = open("/user/gpenn/nd280software/nd280release_12.31/antiNumuCC1piAnalysis_1.0/scripts/batch/run9/submit_batch_jobs_run9.sh", 'w')
...
for list in lists:
    count += 1
    shname = "/user/gpenn/nd280software/nd280release_12.31/antiNumuCC1piAnalysis_1.0/scripts/batch/run9/submit_run9_" + str(count) + ".sh"
    ...
    shfile.write("RunAntiNumuCC1piAnalysis.exe " + list.strip() + " -o output/run9/oaAnalysis_prod6Trun9_" + str(count) + ".root\n")
    shfile.close()
