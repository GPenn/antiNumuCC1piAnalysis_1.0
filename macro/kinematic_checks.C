{
  ...
  draw.SetTitleX("Antimuon true momentum");
  ...
  draw.Draw(default,"arccos(selmu_costheta)",30,0,90,"particle","accum_level[][0]>4");
  draw.DrawCutLineVertical(arccos(0.4),true,"r");
