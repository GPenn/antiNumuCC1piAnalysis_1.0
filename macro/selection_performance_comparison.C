{
  ...
  draw_ori.DrawEff(truth,"truelepton_mom",30,0,6000,"accum_level[][1]>8", "topology==1", "", "", "Original selection");
  draw_mod.DrawEff(truth,"truelepton_mom",30,0,6000,"accum_level[][1]>9", "topology==1", "same", "", "Modified selection");
