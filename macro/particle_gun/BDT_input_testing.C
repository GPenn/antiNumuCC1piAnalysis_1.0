{
  ...
  TCanvas fgd1EbyL;
  draw.Draw(default,"selmu_fgd1_energy/selmu_fgd1_length",50,0,1.5,"particle","accum_level[][0]>5");
  ...
  TCanvas fgd2EbyL;
  draw.Draw(default,"selmu_fgd2_energy/selmu_fgd2_length",50,0,1.5,"particle","accum_level[][0]>5");
}
