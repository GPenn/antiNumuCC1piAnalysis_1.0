{
  ...
  overall_mom->SaveAs("img/particlegun/migration_checks_piplus_truemom_accum4_pg.png");
  ...
  overall_recomom->SaveAs("img/particlegun/migration_checks_piplus_recomom_accum4_pg.png");
}
