{
  ...
  draw.DrawEff(default, "selmu_mom",50,0,5000,"particle_pg==-13","accum_level[][0]>6");
  ...
  draw.DrawEff(default, "selmu_mom",50,0,5000,"particle_pg==211","accum_level[][1]>6");
  ...
  draw.DrawEff(default, "selmu_mom",50,0,5000,"particle_pg==2212","accum_level[][2]>6");
  ...
  draw.DrawEff(default, "selmu_mom",50,0,5000,"particle_pg==-11","accum_level[][3]>6");
