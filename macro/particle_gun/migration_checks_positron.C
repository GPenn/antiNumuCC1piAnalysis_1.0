{
  ...
  overall_mom->SaveAs("img/particlegun/migration_checks_positron_truemom_accum4_pg.png");
  ...
  overall_recomom->SaveAs("img/particlegun/migration_checks_positron_recomom_accum4_pg.png");
}
