{
    ...
    DataSample* MC = new DataSample("/bundle/data/T2K/users/gpenn/highlandBDTtests/final/cc1pi/muonrejection/oaAnalysis_prod6Trun5_1.root");
    ...
    DataSample * data = new DataSample("/bundle/data/T2K/users/gpenn/highlandBDTtests/final/cc1pi/muonrejection/real_data/real_data_run5_all.root");
    data->AddHeader("/bundle/data/T2K/users/gpenn/highlandBDTtests/final/cc1pi/muonrejection/real_data/real_data_run6_all.root");
    data->AddHeader("/bundle/data/T2K/users/gpenn/highlandBDTtests/final/cc1pi/muonrejection/real_data/real_data_run7_all.root");
    data->AddHeader("/bundle/data/T2K/users/gpenn/highlandBDTtests/final/cc1pi/muonrejection/real_data/real_data_run9_all.root");
