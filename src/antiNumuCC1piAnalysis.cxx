...
//********************************************************************
  ...
  if (mybox().MainTrack  ) 
  {
    ...
    BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().MainTrack, mybox().MainTrackLocalECalSegment, "BDTG_0.1shrinkage");
    ...
    BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().MainTrack, mybox().MainTrackLocalECalSegment, "BDTG_0.3shrinkage");
    ...
    BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().MainTrack, mybox().MainTrackLocalECalSegment, "BDTG_0.5shrinkage");
    ...
    BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().MainTrack, mybox().MainTrackLocalECalSegment, "BDTG_0.7shrinkage");
    ...
    BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().MainTrack, mybox().MainTrackLocalECalSegment, "BDTG_0.9shrinkage");
  ...
  if (mybox().HMNtrack  ) 
  {
    ...
    else
    {
      ...
      BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().HMNtrack, mybox().HMNTLocalECalSegment, "BDTG_0.1shrinkage");
      output().FillVar(hmnt_bdt_pid_pi_test1, BDT_PID_results_vector[1]);
    
      BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().HMNtrack, mybox().HMNTLocalECalSegment, "BDTG_0.3shrinkage");
      output().FillVar(hmnt_bdt_pid_pi_test2, BDT_PID_results_vector[1]);
    
      BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().HMNtrack, mybox().HMNTLocalECalSegment, "BDTG_0.5shrinkage");
      output().FillVar(hmnt_bdt_pid_pi_test3, BDT_PID_results_vector[1]);
    
      BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().HMNtrack, mybox().HMNTLocalECalSegment, "BDTG_0.7shrinkage");
      output().FillVar(hmnt_bdt_pid_pi_test4, BDT_PID_results_vector[1]);
    
      BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().HMNtrack, mybox().HMNTLocalECalSegment, "BDTG_0.9shrinkage");
