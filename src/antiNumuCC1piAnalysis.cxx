...
//********************************************************************
  ...
  if (mybox().MainTrack  ) 
  {
    ...
    std::vector<Float_t> BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().MainTrack, mybox().MainTrackLocalECalSegment, "BDTG_tpcdedx");
  ...
  if (mybox().HMNtrack  ) 
  {
    ...
    else
    {
      ...
      std::vector<Float_t> BDT_PID_results_vector = myBDTPIDmanagerCC1pi->GetBDTPIDVarsPos(mybox().HMNtrack, mybox().HMNTLocalECalSegment, "BDTG_tpcdedx");
