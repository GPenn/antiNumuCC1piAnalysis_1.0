...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheCore_3.41 in  /hepstore/gpenn/nd280gitlab/12.31/psycheCore_3.41  FAILED          " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  echo "" ; echo " Building psycheCore_3.41  ( package number " 4 " out of " 24 " ) " ; echo "" 
   makeTarget=$1 
  if [ "$1" == "documentation" ] ; then makeTarget=psycheCore_$1 ; fi 
   cd  /hepstore/gpenn/nd280gitlab/12.31/psycheCore_3.41 
