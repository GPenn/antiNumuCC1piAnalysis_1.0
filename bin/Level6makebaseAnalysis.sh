...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package baseAnalysis_2.33 in  /user/gpenn/nd280software/nd280release_12.31/baseAnalysis_2.33  FAILED          " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  ...
  if [ "$1" == "documentation" ] ; then makeTarget=baseAnalysis_$1 ; fi 
   cd  /user/gpenn/nd280software/nd280release_12.31/baseAnalysis_2.33 
