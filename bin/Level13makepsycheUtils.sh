...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package psycheUtils_3.34 in  /hepstore/gpenn/nd280gitlab/12.31/psycheUtils_3.34  FAILED          " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  ...
  if [ "$1" == "documentation" ] ; then makeTarget=psycheUtils_$1 ; fi 
   cd  /hepstore/gpenn/nd280gitlab/12.31/psycheUtils_3.34 
