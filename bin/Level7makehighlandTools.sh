...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package highlandTools_2.29 in  /user/gpenn/nd280software/nd280release_12.31/highlandTools_2.29  FAILED          " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  ...
  if [ "$1" == "documentation" ] ; then makeTarget=highlandTools_$1 ; fi 
   cd  /user/gpenn/nd280software/nd280release_12.31/highlandTools_2.29 
