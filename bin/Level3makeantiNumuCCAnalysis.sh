...
function shout {
  echo "+=======================================+" 
 echo "+                                       +" 
 echo "   Build of package antiNumuCCAnalysis_2.7 in  /user/gpenn/nd280software/nd280release_12.31/antiNumuCCAnalysis_2.7  FAILED          " 
 echo "+                                       +" 
 echo "+=======================================+" 
 exit 1 
 } 
 trap shout ERR 
  ...
  if [ "$1" == "documentation" ] ; then makeTarget=antiNumuCCAnalysis_$1 ; fi 
   cd  /user/gpenn/nd280software/nd280release_12.31/antiNumuCCAnalysis_2.7 
