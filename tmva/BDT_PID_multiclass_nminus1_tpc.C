...
void BDT_PID_multiclass_nminus1_tpc( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_tpc" << std::endl;
   ...
   TString outfileName( "output/BDT_PID_multiclass_nminus1_tpc.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_tpc", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_tpc       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_tpc is done!" << std::endl;
