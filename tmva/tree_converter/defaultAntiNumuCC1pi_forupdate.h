...
// Fri Jun 18 15:04:08 2021 by ROOT version 5.34/34
// from TTree default/20
// found on file: ../../output/particle_gun/localglobaltest2.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../output/particle_gun/localglobaltest2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../output/particle_gun/localglobaltest2.root");
      }
