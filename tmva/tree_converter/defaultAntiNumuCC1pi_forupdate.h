...
// Tue Jan 25 12:16:51 2022 by ROOT version 5.34/34
// from TTree default/20
// found on file: ../../output/particle_gun/particlegun_allpositive_testing.root
//////////////////////////////////////////////////////////

#ifndef defaultAntiNumuCC1pi_forupdate_h
#define defaultAntiNumuCC1pi_forupdate_h
...
class defaultAntiNumuCC1pi_forupdate {
public :
   ...
   defaultAntiNumuCC1pi_forupdate(TTree *tree=0);
   virtual ~defaultAntiNumuCC1pi_forupdate();
...
#ifdef defaultAntiNumuCC1pi_forupdate_cxx
defaultAntiNumuCC1pi_forupdate::defaultAntiNumuCC1pi_forupdate(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../output/particle_gun/particlegun_allpositive_testing.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../output/particle_gun/particlegun_allpositive_testing.root");
      }
...
defaultAntiNumuCC1pi_forupdate::~defaultAntiNumuCC1pi_forupdate()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t defaultAntiNumuCC1pi_forupdate::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t defaultAntiNumuCC1pi_forupdate::LoadTree(Long64_t entry)
{
...
void defaultAntiNumuCC1pi_forupdate::Init(TTree *tree)
{
...
Bool_t defaultAntiNumuCC1pi_forupdate::Notify()
{
...
void defaultAntiNumuCC1pi_forupdate::Show(Long64_t entry)
{
...
Int_t defaultAntiNumuCC1pi_forupdate::Cut(Long64_t entry)
{
...
#endif // #ifdef defaultAntiNumuCC1pi_forupdate_cxx
