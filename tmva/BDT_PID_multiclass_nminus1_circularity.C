...
void BDT_PID_multiclass_nminus1_circularity( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_circularity" << std::endl;
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_circularity", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_circularity       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_circularity is done!" << std::endl;
