...
#include "TMVA/Factory.h"// @(#)root/tmva $Id$
/**********************************************************************************
 * Project   : TMVA - a ROOT-integrated toolkit for multivariate data analysis    *
 * Package   : TMVA                                                               *
 * Root Macro: TMVAClassification                                                 *
...
void BDT_PID_multiclass_nminus1_ecalEbyL_nminus1_mom( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_ecalEbyL" << std::endl;
   ...
   TString outfileName( "output/BDT_PID_multiclass_nminus1_ecalEbyL.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_ecalEbyL", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_ecalEbyL       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_ecalEbyL is done!" << std::endl;
...
void BDT_PID_multiclass_nminus1_ecalEbyL_nminus1_mom( TString myMethodList = "" )
{
   ...
   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
   TString outfileName( "output/BDT_PID_multiclass_nminus1_ecalEbyL_nminus1_mom.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
