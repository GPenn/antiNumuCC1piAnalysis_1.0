...
void BDT_PID_multiclass( TString myMethodList = "" )
{
   ...
   //factory->BookMethod( TMVA::Types::kBDT, "BDTG_bsf0.1", "!H:!V:NTrees=1000:BoostType=Grad:Shrinkage=0.50:UseBaggedBoost:BaggedSampleFraction=0.10:nCuts=2500:MaxDepth=3");
