...
void BDT_PID_multiclass_nminus1_fgd2EbyL( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_fgd2EbyL" << std::endl;
   ...
   TString outfileName( "output/BDT_PID_multiclass_nminus1_fgd2EbyL.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_fgd2EbyL", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_fgd2EbyL       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_fgd2EbyL is done!" << std::endl;
