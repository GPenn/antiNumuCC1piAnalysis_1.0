...
void BDT_PID_multiclass_nminus1_fgd( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_fgd" << std::endl;
   ...
   TString outfileName( "output/BDT_PID_multiclass_nminus1_fgd.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_fgd", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_fgd       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_fgd is done!" << std::endl;
