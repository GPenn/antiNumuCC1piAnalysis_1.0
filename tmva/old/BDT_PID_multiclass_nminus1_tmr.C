...
void BDT_PID_multiclass_nminus1_tmr( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_tmr" << std::endl;
   ...
   TString outfileName( "output/BDT_PID_multiclass_nminus1_tmr.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_tmr", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_tmr       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_tmr is done!" << std::endl;
