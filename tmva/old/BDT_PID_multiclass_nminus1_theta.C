...
void BDT_PID_multiclass_nminus1_theta( TString myMethodList = "" )
{
   ...
   std::cout << std::endl;
   std::cout << "==> Start BDT_PID_multiclass_nminus1_theta" << std::endl;
   ...
   TString outfileName( "output/BDT_PID_multiclass_nminus1_theta.root" );
   ...
   TMVA::Factory *factory = new TMVA::Factory( "BDT_PID_multiclass_nminus1_theta", outputFile,
   ...
   std::cout << "--- BDT_PID_multiclass_nminus1_theta       : Using input files: " << std::endl 
   ...
   std::cout << "==> BDT_PID_multiclass_nminus1_theta is done!" << std::endl;
