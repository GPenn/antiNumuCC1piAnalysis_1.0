...
// Thu Feb 24 15:00:26 2022 by ROOT version 5.34/34
// from TTree default/20
// found on file: ../../output/existing_selection/oaAnalysis_prod6Trun5_1.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           NPi0El;
   Float_t         Pi0ElMom[2];   //[NPi0El]
   Float_t         Pi0ElPull[2];   //[NPi0El]
   Int_t           Pi0ElTId[2];   //[NPi0El]
   Int_t           Pi0ElIndex[2];   //[NPi0El]
   Int_t           Pi0ElParentTId[2];   //[NPi0El]
   Int_t           Pi0ElGParentTId[2];   //[NPi0El]
   Int_t           Pi0ElVId[2];   //[NPi0El]
   Float_t         Pi0ElDir[2][3];   //[NPi0El]
   Float_t         Pi0ElPosStart[2][3];   //[NPi0El]
   Float_t         Pi0ElPosEnd[2][3];   //[NPi0El]
   Int_t           NPi0Pos;
   ...
   Int_t           NTPCSec;
   Float_t         TPCSecMom[6];   //[NTPCSec]
   Float_t         TPCSecMuPidLik[6];   //[NTPCSec]
   Float_t         TPCSecPiPidLik[6];   //[NTPCSec]
   Float_t         TPCSecPrPidLik[6];   //[NTPCSec]
   Float_t         TPCSecElPidLik[6];   //[NTPCSec]
   Int_t           TPCSecDetectors[6];   //[NTPCSec]
   Int_t           TPCSecQ[6];   //[NTPCSec]
   Int_t           TPCSecTId[6];   //[NTPCSec]
   Int_t           TPCSecIndex[6];   //[NTPCSec]
   Int_t           TPCSecParentTId[6];   //[NTPCSec]
   Int_t           TPCSecGParentTId[6];   //[NTPCSec]
   Float_t         TPCSecDir[6][3];   //[NTPCSec]
   Float_t         TPCSecPosStart[6][3];   //[NTPCSec]
   Float_t         TPCSecPosEnd[6][3];   //[NTPCSec]
   Int_t           NFGDPi;
   ...
   Int_t           NFGDSec;
   Float_t         FGDSecLength[5];   //[NFGDSec]
   Float_t         FGDSecPiPull[5];   //[NFGDSec]
   Float_t         FGDSecAvgTime[5];   //[NFGDSec]
   Int_t           FGDSecContained[5];   //[NFGDSec]
   Int_t           FGDSecTId[5];   //[NFGDSec]
   Int_t           FGDSecIndex[5];   //[NFGDSec]
   Int_t           FGDSecParentTId[5];   //[NFGDSec]
   Int_t           FGDSecGParentTId[5];   //[NFGDSec]
   Float_t         FGDSecTimeIni[5];   //[NFGDSec]
   Float_t         FGDSecTimeEnd[5];   //[NFGDSec]
   Float_t         FGDSecDeltaTimeIniSelMu[5];   //[NFGDSec]
   Float_t         FGDSecDeltaTimeEndSelMu[5];   //[NFGDSec]
   Float_t         FGDSecCosTheta[5];   //[NFGDSec]
   Float_t         FGDSecDir[5][3];   //[NFGDSec]
   Float_t         FGDSecPosStart[5][3];   //[NFGDSec]
   Float_t         FGDSecPosEnd[5][3];   //[NFGDSec]
   Int_t           NME;
   Int_t           MENHits[1];   //[NME]
   ...
   Int_t           NTPC1Track;
   Float_t         TPC1TrackMom[7];   //[NTPC1Track]
   Float_t         TPC1TrackCosTheta[7];   //[NTPC1Track]
   Float_t         TPC1TrackPhi[7];   //[NTPC1Track]
   Int_t           TPC1TrackVId[7];   //[NTPC1Track]
   Int_t           TPC1TrackTId[7];   //[NTPC1Track]
   Int_t           TPC1TrackParentTId[7];   //[NTPC1Track]
   Int_t           TPC1TrackGParentTId[7];   //[NTPC1Track]
   Float_t         TPC1TrackPosStart[7][3];   //[NTPC1Track]
   Float_t         TPC1TrackPosEnd[7][3];   //[NTPC1Track]
   Float_t         truepi_mom;
   ...
   Int_t           true_nprotons;
   Int_t           nProtonsFGD;
   Float_t         FGDProtMom[2];   //[nProtonsFGD]
   Int_t           FGDProtonTId[2];   //[nProtonsFGD]
   Int_t           nProtonsTPC;
   Float_t         TPCProtMom[1];   //[nProtonsTPC]
   Int_t           TPCProtonTId[1];   //[nProtonsTPC]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../output/existing_selection/oaAnalysis_prod6Trun5_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../output/existing_selection/oaAnalysis_prod6Trun5_1.root");
      }
