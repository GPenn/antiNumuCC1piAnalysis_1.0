...
// Mon Nov 15 12:42:57 2021 by ROOT version 5.34/34
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../output/particle_gun/particlegun_allpositive_bdttest.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../output/particle_gun/particlegun_allpositive_bdttest.root");
      }
