{
    ...
    ECal_musel_mu->Fill(ecalvarchoices[0],0.928829);
    ECal_musel_pi->Fill(ecalvarchoices[0],0.321837); 
    ECal_musel_p->Fill(ecalvarchoices[0],0.0194994);
    ECal_musel_e->Fill(ecalvarchoices[0],0.0137194);
    ECal_pisel_mu->Fill(ecalvarchoices[0],0.0600165);
    ECal_pisel_pi->Fill(ecalvarchoices[0],0.634636);
    ECal_pisel_p->Fill(ecalvarchoices[0],0.0368206);
    ECal_pisel_e->Fill(ecalvarchoices[0],0.0131849);
    ECal_psel_mu->Fill(ecalvarchoices[0],0.00728658);
    ECal_psel_pi->Fill(ecalvarchoices[0],0.0293201);
    ECal_psel_p->Fill(ecalvarchoices[0],0.898458);
    ECal_psel_e->Fill(ecalvarchoices[0],0.0406682);
    ECal_esel_mu->Fill(ecalvarchoices[0],0.00386783);
    ECal_esel_pi->Fill(ecalvarchoices[0],0.0142065);
    ECal_esel_p->Fill(ecalvarchoices[0],0.045222);
    ECal_esel_e->Fill(ecalvarchoices[0],0.932428);
    
    ECal_musel_mu->Fill(ecalvarchoices[1],0.952659);
    ECal_musel_pi->Fill(ecalvarchoices[1],0.390935); 
    ECal_musel_p->Fill(ecalvarchoices[1],0.0396556);
    ECal_musel_e->Fill(ecalvarchoices[1],0.051121);
    ECal_pisel_mu->Fill(ecalvarchoices[1],0.0416624);
    ECal_pisel_pi->Fill(ecalvarchoices[1],0.58921);
    ECal_pisel_p->Fill(ecalvarchoices[1],0.0528108);
    ECal_pisel_e->Fill(ecalvarchoices[1],0.227409);
    ECal_psel_mu->Fill(ecalvarchoices[1],0.00518608);
    ECal_psel_pi->Fill(ecalvarchoices[1],0.0162091);
    ECal_psel_p->Fill(ecalvarchoices[1],0.895208);
    ECal_psel_e->Fill(ecalvarchoices[1],0.169844);
    ECal_esel_mu->Fill(ecalvarchoices[1],0.000492532);
    ECal_esel_pi->Fill(ecalvarchoices[1],0.00364576);
    ECal_esel_p->Fill(ecalvarchoices[1],0.0123254);
    ECal_esel_e->Fill(ecalvarchoices[1],0.551626);
    ...
    ECal_pisel_mu->GetYaxis()->SetRangeUser(0, 0.35);
    ...
    ECal_musel_mu_diff->GetYaxis()->SetRangeUser(-0.4, 0.05);
    ECal_musel_mu_diff->GetXaxis()->SetRangeUser(1, 2);
