{
    ...
    ECal_musel_mu->Fill(ecalvarchoices[0],0.974798);
    ECal_musel_pi->Fill(ecalvarchoices[0],0.505285); 
    ECal_musel_p->Fill(ecalvarchoices[0],0.0603783);
    ECal_musel_e->Fill(ecalvarchoices[0],0.0539036);
    ECal_pisel_mu->Fill(ecalvarchoices[0],0.0215541);
    ECal_pisel_pi->Fill(ecalvarchoices[0],0.471241);
    ECal_pisel_p->Fill(ecalvarchoices[0],0.0557808);
    ECal_pisel_e->Fill(ecalvarchoices[0],0.137057);
    ECal_psel_mu->Fill(ecalvarchoices[0],0.00343071);
    ECal_psel_pi->Fill(ecalvarchoices[0],0.0186156);
    ECal_psel_p->Fill(ecalvarchoices[0],0.868301);
    ECal_psel_e->Fill(ecalvarchoices[0],0.262272);
    ECal_esel_mu->Fill(ecalvarchoices[0],0.000217133);
    ECal_esel_pi->Fill(ecalvarchoices[0],0.00485851);
    ECal_esel_p->Fill(ecalvarchoices[0],0.0155399);
    ECal_esel_e->Fill(ecalvarchoices[0],0.546768);
    
    ECal_musel_mu->Fill(ecalvarchoices[1],0.936612);
    ECal_musel_pi->Fill(ecalvarchoices[1],0.363204); 
    ECal_musel_p->Fill(ecalvarchoices[1],0.0277038);
    ECal_musel_e->Fill(ecalvarchoices[1],0.0397502);
    ECal_pisel_mu->Fill(ecalvarchoices[1],0.0570192);
    ECal_pisel_pi->Fill(ecalvarchoices[1],0.609055);
    ECal_pisel_p->Fill(ecalvarchoices[1],0.0665875);
    ECal_pisel_e->Fill(ecalvarchoices[1],0.112491);
    ECal_psel_mu->Fill(ecalvarchoices[1],0.00602183);
    ECal_psel_pi->Fill(ecalvarchoices[1],0.025825);
    ECal_psel_p->Fill(ecalvarchoices[1],0.894885);
    ECal_psel_e->Fill(ecalvarchoices[1],0.232448);
    ECal_esel_mu->Fill(ecalvarchoices[1],0.000347413);
    ECal_esel_pi->Fill(ecalvarchoices[1],0.00191554);
    ECal_esel_p->Fill(ecalvarchoices[1],0.0108236);
    ECal_esel_e->Fill(ecalvarchoices[1],0.615311);
