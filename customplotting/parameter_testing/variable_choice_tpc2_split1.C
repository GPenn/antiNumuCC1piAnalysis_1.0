{
    ...
    TPC2_musel_mu->Fill(tpc2varchoices[0],0.928289);
    TPC2_musel_pi->Fill(tpc2varchoices[0],0.334697); 
    TPC2_musel_p->Fill(tpc2varchoices[0],0.0214871);
    TPC2_musel_e->Fill(tpc2varchoices[0],0.0600211);
    TPC2_pisel_mu->Fill(tpc2varchoices[0],0.0618413);
    TPC2_pisel_pi->Fill(tpc2varchoices[0],0.621291);
    TPC2_pisel_p->Fill(tpc2varchoices[0],0.0515288);
    TPC2_pisel_e->Fill(tpc2varchoices[0],0.112822);
    TPC2_psel_mu->Fill(tpc2varchoices[0],0.00942397);
    TPC2_psel_pi->Fill(tpc2varchoices[0],0.0424109);
    TPC2_psel_p->Fill(tpc2varchoices[0],0.917126);
    TPC2_psel_e->Fill(tpc2varchoices[0],0.178731);
    TPC2_esel_mu->Fill(tpc2varchoices[0],0.000446105);
    TPC2_esel_pi->Fill(tpc2varchoices[0],0.00160108);
    TPC2_esel_p->Fill(tpc2varchoices[0],0.00985798);
    TPC2_esel_e->Fill(tpc2varchoices[0],0.648426);
    
    TPC2_musel_mu->Fill(tpc2varchoices[1],0.930101);
    TPC2_musel_pi->Fill(tpc2varchoices[1],0.322138); 
    TPC2_musel_p->Fill(tpc2varchoices[1],0.0215205);
    TPC2_musel_e->Fill(tpc2varchoices[1],0.0456123);
    TPC2_pisel_mu->Fill(tpc2varchoices[1],0.0625105);
    TPC2_pisel_pi->Fill(tpc2varchoices[1],0.648082);
    TPC2_pisel_p->Fill(tpc2varchoices[1],0.0403342);
    TPC2_pisel_e->Fill(tpc2varchoices[1],0.107059);
    TPC2_psel_mu->Fill(tpc2varchoices[1],0.00708192);
    TPC2_psel_pi->Fill(tpc2varchoices[1],0.0286416);
    TPC2_psel_p->Fill(tpc2varchoices[1],0.926951);
    TPC2_psel_e->Fill(tpc2varchoices[1],0.169528);
    TPC2_esel_mu->Fill(tpc2varchoices[1],0.000306697);
    TPC2_esel_pi->Fill(tpc2varchoices[1],0.00113855);
    TPC2_esel_p->Fill(tpc2varchoices[1],0.0111947);
    TPC2_esel_e->Fill(tpc2varchoices[1],0.677801);
    
    TPC2_musel_mu->Fill(tpc2varchoices[2],0.929292);
    TPC2_musel_pi->Fill(tpc2varchoices[2],0.323739); 
    TPC2_musel_p->Fill(tpc2varchoices[2],0.0220217);
    TPC2_musel_e->Fill(tpc2varchoices[2],0.0336515);
    TPC2_pisel_mu->Fill(tpc2varchoices[2],0.0629844);
    TPC2_pisel_pi->Fill(tpc2varchoices[2],0.639543);
    TPC2_pisel_p->Fill(tpc2varchoices[2],0.0580117);
    TPC2_pisel_e->Fill(tpc2varchoices[2],0.107338);
    TPC2_psel_mu->Fill(tpc2varchoices[2],0.00741649);
    TPC2_psel_pi->Fill(tpc2varchoices[2],0.0338718);
    TPC2_psel_p->Fill(tpc2varchoices[2],0.911211);
    TPC2_psel_e->Fill(tpc2varchoices[2],0.189173);
    TPC2_esel_mu->Fill(tpc2varchoices[2],0.000306697);
    TPC2_esel_pi->Fill(tpc2varchoices[2],0.00284637);
    TPC2_esel_p->Fill(tpc2varchoices[2],0.00875522);
    TPC2_esel_e->Fill(tpc2varchoices[2],0.669838);
