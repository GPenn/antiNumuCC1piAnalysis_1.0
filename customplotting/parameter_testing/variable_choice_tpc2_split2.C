{
    ...
    TPC2_musel_mu->Fill(tpc2varchoices[0],0.930167);
    TPC2_musel_pi->Fill(tpc2varchoices[0],0.334224); 
    TPC2_musel_p->Fill(tpc2varchoices[0],0.0219532);
    TPC2_musel_e->Fill(tpc2varchoices[0],0.0587263);
    TPC2_pisel_mu->Fill(tpc2varchoices[0],0.0609076);
    TPC2_pisel_pi->Fill(tpc2varchoices[0],0.624843);
    TPC2_pisel_p->Fill(tpc2varchoices[0],0.0514271);
    TPC2_pisel_e->Fill(tpc2varchoices[0],0.117053);
    TPC2_psel_mu->Fill(tpc2varchoices[0],0.00850294);
    TPC2_psel_pi->Fill(tpc2varchoices[0],0.0394815);
    TPC2_psel_p->Fill(tpc2varchoices[0],0.915088);
    TPC2_psel_e->Fill(tpc2varchoices[0],0.179742);
    TPC2_esel_mu->Fill(tpc2varchoices[0],0.000422132);
    TPC2_esel_pi->Fill(tpc2varchoices[0],0.00145128);
    TPC2_esel_p->Fill(tpc2varchoices[0],0.0115317);
    TPC2_esel_e->Fill(tpc2varchoices[0],0.644478);
    
    TPC2_musel_mu->Fill(tpc2varchoices[1],0.930107);
    TPC2_musel_pi->Fill(tpc2varchoices[1],0.321129); 
    TPC2_musel_p->Fill(tpc2varchoices[1],0.0208072);
    TPC2_musel_e->Fill(tpc2varchoices[1],0.0439877);
    TPC2_pisel_mu->Fill(tpc2varchoices[1],0.062566);
    TPC2_pisel_pi->Fill(tpc2varchoices[1],0.650966);
    TPC2_pisel_p->Fill(tpc2varchoices[1],0.044372);
    TPC2_pisel_e->Fill(tpc2varchoices[1],0.109157);
    TPC2_psel_mu->Fill(tpc2varchoices[1],0.00702548);
    TPC2_psel_pi->Fill(tpc2varchoices[1],0.026321);
    TPC2_psel_p->Fill(tpc2varchoices[1],0.922752);
    TPC2_psel_e->Fill(tpc2varchoices[1],0.171304);
    TPC2_esel_mu->Fill(tpc2varchoices[1],0.000301523);
    TPC2_esel_pi->Fill(tpc2varchoices[1],0.00158322);
    TPC2_esel_p->Fill(tpc2varchoices[1],0.0120689);
    TPC2_esel_e->Fill(tpc2varchoices[1],0.675552);
    
    TPC2_musel_mu->Fill(tpc2varchoices[2],0.927815);
    TPC2_musel_pi->Fill(tpc2varchoices[2],0.322647); 
    TPC2_musel_p->Fill(tpc2varchoices[2],0.0224904);
    TPC2_musel_e->Fill(tpc2varchoices[2],0.0320429);
    TPC2_pisel_mu->Fill(tpc2varchoices[2],0.063953);
    TPC2_pisel_pi->Fill(tpc2varchoices[2],0.64249);
    TPC2_pisel_p->Fill(tpc2varchoices[2],0.05662);
    TPC2_pisel_e->Fill(tpc2varchoices[2],0.111951);
    TPC2_psel_mu->Fill(tpc2varchoices[2],0.00799035);
    TPC2_psel_pi->Fill(tpc2varchoices[2],0.032357);
    TPC2_psel_p->Fill(tpc2varchoices[2],0.910719);
    TPC2_psel_e->Fill(tpc2varchoices[2],0.18952);
    TPC2_esel_mu->Fill(tpc2varchoices[2],0.000241218);
    TPC2_esel_pi->Fill(tpc2varchoices[2],0.00250676);
    TPC2_esel_p->Fill(tpc2varchoices[2],0.0101708);
    TPC2_esel_e->Fill(tpc2varchoices[2],0.666486);
