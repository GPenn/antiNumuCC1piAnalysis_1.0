{
    ...
    treedepth_pg_mu->SetPoint(0, 2.0, 0.932088);
    treedepth_pg_mu->SetPoint(1, 3.0, 0.);
    treedepth_pg_mu->SetPoint(2, 4.0, 0.);
    treedepth_pg_mu->SetPoint(3, 5.0, 0.);
    ...
    treedepth_pg_pi->SetPoint(0, 2.0, 0.);
    treedepth_pg_pi->SetPoint(1, 3.0, 0.);
    treedepth_pg_pi->SetPoint(2, 4.0, 0.);
    treedepth_pg_pi->SetPoint(3, 5.0, 0.);
    ...
    treedepth_pg_p->SetPoint(0, 2.0, 0.);
    treedepth_pg_p->SetPoint(1, 3.0, 0.);
    treedepth_pg_p->SetPoint(2, 4.0, 0.);
    treedepth_pg_p->SetPoint(3, 5.0, 0.);
    ...
    treedepth_pg_e->SetPoint(0, 2.0, 0.);
    treedepth_pg_e->SetPoint(1, 3.0, 0.);
    treedepth_pg_e->SetPoint(2, 4.0, 0.);
    treedepth_pg_e->SetPoint(3, 5.0, 0.);
    ...
    treedepth_pg_diff_pi->SetPoint(3, 5.0, 0.-refvalue_pg_pi);
    ...
    treedepth_pg_diff_p->SetPoint(3, 5.0, 0.-refvalue_pg_p);
    ...
    treedepth_pg_diff_e->SetPoint(3, 5.0, 0.-refvalue_pg_e);
    ...
    shrinkage_pg_mu->SetPoint(3, 0.7, 0.935623);
    shrinkage_pg_mu->SetPoint(4, 0.9, 0.933117);
    ...
    shrinkage_pg_pi->SetPoint(3, 0.7, 0.58553);
    shrinkage_pg_pi->SetPoint(4, 0.9, 0.589809);
    ...
    shrinkage_pg_p->SetPoint(3, 0.7, 0.915589);
    shrinkage_pg_p->SetPoint(4, 0.9, 0.91692);
    ...
    shrinkage_pg_e->SetPoint(3, 0.7, 0.631878);
    shrinkage_pg_e->SetPoint(4, 0.9, 0.633645);
    ...
    shrinkage_pg_diff_mu->SetPoint(3, 0.7, 0.935623-refvalue_pg_mu);
    shrinkage_pg_diff_mu->SetPoint(4, 0.9, 0.933117-refvalue_pg_mu);
    ...
    shrinkage_pg_diff_pi->SetPoint(3, 0.7, 0.58553-refvalue_pg_pi);
    shrinkage_pg_diff_pi->SetPoint(4, 0.9, 0.589809-refvalue_pg_pi);
    ...
    shrinkage_pg_diff_p->SetPoint(3, 0.7, 0.915589-refvalue_pg_p);
    shrinkage_pg_diff_p->SetPoint(4, 0.9, 0.91692-refvalue_pg_p);
    ...
    shrinkage_pg_diff_e->SetPoint(3, 0.7, 0.631878-refvalue_pg_e);
    shrinkage_pg_diff_e->SetPoint(4, 0.9, 0.633645-refvalue_pg_e);
    ...
    randomforests_pg_mu->SetPoint(3, 6, 0.93529);
    randomforests_pg_mu->SetPoint(4, 8, 0.933957);
    randomforests_pg_mu->SetPoint(5, 10, 0.93416);
    randomforests_pg_mu->SetPoint(6, 12, 0.934131);
    ...
    randomforests_pg_pi->SetPoint(3, 6, 0.590716);
    randomforests_pg_pi->SetPoint(4, 8, 0.58933);
    randomforests_pg_pi->SetPoint(5, 10, 0.588868);
    randomforests_pg_pi->SetPoint(6, 12, 0.58921);
    ...
    randomforests_pg_p->SetPoint(3, 6, 0.914777);
    randomforests_pg_p->SetPoint(4, 8, 0.917076);
    randomforests_pg_p->SetPoint(5, 10, 0.917525);
    randomforests_pg_p->SetPoint(6, 12, 0.917698);
    ...
    randomforests_pg_e->SetPoint(3, 6, 0.637045);
    randomforests_pg_e->SetPoint(4, 8, 0.652546);
    randomforests_pg_e->SetPoint(5, 10, 0.652546);
    randomforests_pg_e->SetPoint(6, 12, 0.658233);
    ...
    randomforests_pg_diff_mu->SetPoint(3, 6, 0.93529-refvalue_pg_mu);
    randomforests_pg_diff_mu->SetPoint(4, 8, 0.933957-refvalue_pg_mu);
    randomforests_pg_diff_mu->SetPoint(5, 10, 0.93416-refvalue_pg_mu);
    randomforests_pg_diff_mu->SetPoint(6, 12, 0.934131-refvalue_pg_mu);
    ...
    randomforests_pg_diff_pi->SetPoint(3, 6, 0.590716-refvalue_pg_pi);
    randomforests_pg_diff_pi->SetPoint(4, 8, 0.58933-refvalue_pg_pi);
    randomforests_pg_diff_pi->SetPoint(5, 10, 0.588868-refvalue_pg_pi);
    randomforests_pg_diff_pi->SetPoint(6, 12, 0.58921-refvalue_pg_pi);
    ...
    randomforests_pg_diff_p->SetPoint(3, 6, 0.914777-refvalue_pg_p);
    randomforests_pg_diff_p->SetPoint(4, 8, 0.917076-refvalue_pg_p);
    randomforests_pg_diff_p->SetPoint(5, 10, 0.917525-refvalue_pg_p);
    randomforests_pg_diff_p->SetPoint(6, 12, 0.917698-refvalue_pg_p);
    ...
    randomforests_pg_diff_e->SetPoint(3, 6, 0.637045-refvalue_pg_e);
    randomforests_pg_diff_e->SetPoint(4, 8, 0.652546-refvalue_pg_e);
    randomforests_pg_diff_e->SetPoint(5, 10, 0.660772-refvalue_pg_e);
    randomforests_pg_diff_e->SetPoint(6, 12, 0.658233-refvalue_pg_e);
