{
    ...
    treedepth_pg_diff_mu->SetPoint(0, 2.0, treedepth_pg_mu->GetPointY(0)-refvalue_pg_mu);
    treedepth_pg_diff_mu->SetPoint(1, 3.0, treedepth_pg_mu->GetPointY(1)-refvalue_pg_mu);
    treedepth_pg_diff_mu->SetPoint(2, 4.0, treedepth_pg_mu->GetPointY(2)-refvalue_pg_mu);
    treedepth_pg_diff_mu->SetPoint(3, 5.0, treedepth_pg_mu->GetPointY(3)-refvalue_pg_mu);
    ...
    treedepth_pg_diff_pi->SetPoint(0, 2.0, treedepth_pg_pi->GetPointY(0)-refvalue_pg_pi);
    treedepth_pg_diff_pi->SetPoint(1, 3.0, treedepth_pg_pi->GetPointY(1)-refvalue_pg_pi);
    treedepth_pg_diff_pi->SetPoint(2, 4.0, treedepth_pg_pi->GetPointY(2)-refvalue_pg_pi);
    treedepth_pg_diff_pi->SetPoint(3, 5.0, treedepth_pg_pi->GetPointY(3)-refvalue_pg_pi);
    ...
    treedepth_pg_diff_p->SetPoint(0, 2.0, treedepth_pg_p->GetPointY(0)-refvalue_pg_p);
    treedepth_pg_diff_p->SetPoint(1, 3.0, treedepth_pg_p->GetPointY(1)-refvalue_pg_p);
    treedepth_pg_diff_p->SetPoint(2, 4.0, treedepth_pg_p->GetPointY(2)-refvalue_pg_p);
    treedepth_pg_diff_p->SetPoint(3, 5.0, treedepth_pg_p->GetPointY(3)-refvalue_pg_p);
    ...
    treedepth_pg_diff_e->SetPoint(0, 2.0, treedepth_pg_e->GetPointY(0)-refvalue_pg_e);
    treedepth_pg_diff_e->SetPoint(1, 3.0, treedepth_pg_e->GetPointY(1)-refvalue_pg_e);
    treedepth_pg_diff_e->SetPoint(2, 4.0, treedepth_pg_e->GetPointY(2)-refvalue_pg_e);
    treedepth_pg_diff_e->SetPoint(3, 5.0, treedepth_pg_e->GetPointY(3)-refvalue_pg_e);
    ...
    treenumber_pg_mu->SetPoint(0, 500.0, 0.968545);
    treenumber_pg_mu->SetPoint(1, 1000.0, 0.963724);
    treenumber_pg_mu->SetPoint(2, 1500.0, 0.955676);
    treenumber_pg_mu->SetPoint(3, 2000.0, 0.946658);
    treenumber_pg_mu->SetPoint(4, 2500.0, 0.939796);
    ...
    treenumber_pg_pi->SetPoint(0, 500.0, 0.504641);
    treenumber_pg_pi->SetPoint(1, 1000.0, 0.525485);
    treenumber_pg_pi->SetPoint(2, 1500.0, 0.554236);
    treenumber_pg_pi->SetPoint(3, 2000.0, 0.583126);
    treenumber_pg_pi->SetPoint(4, 2500.0, 0.597736);
    ...
    treenumber_pg_p->SetPoint(0, 500.0, 0.850267);
    treenumber_pg_p->SetPoint(1, 1000.0, 0.845924);
    treenumber_pg_p->SetPoint(2, 1500.0, 0.842328);
    treenumber_pg_p->SetPoint(3, 2000.0, 0.837001);
    treenumber_pg_p->SetPoint(4, 2500.0, 0.831826);
    ...
    treenumber_pg_e->SetPoint(0, 500.0, 0.54774);
    treenumber_pg_e->SetPoint(1, 1000.0, 0.549095);
    treenumber_pg_e->SetPoint(2, 1500.0, 0.549714);
    treenumber_pg_e->SetPoint(3, 2000.0, 0.550023);
    treenumber_pg_e->SetPoint(4, 2500.0, 0.550288);
    ...
    treenumber_pg_diff_mu->SetPoint(0, 500.0, 0.968545-refvalue_pg_mu);
    treenumber_pg_diff_mu->SetPoint(1, 1000.0, 0.963724-refvalue_pg_mu);
    treenumber_pg_diff_mu->SetPoint(2, 1500.0, 0.955676-refvalue_pg_mu);
    treenumber_pg_diff_mu->SetPoint(3, 2000.0, 0.946658-refvalue_pg_mu);
    treenumber_pg_diff_mu->SetPoint(4, 2500.0, 0.939796-refvalue_pg_mu);
    ...
    treenumber_pg_diff_pi->SetPoint(0, 500.0, 0.504641-refvalue_pg_pi);
    treenumber_pg_diff_pi->SetPoint(1, 1000.0, 0.525485-refvalue_pg_pi);
    treenumber_pg_diff_pi->SetPoint(2, 1500.0, 0.554236-refvalue_pg_pi);
    treenumber_pg_diff_pi->SetPoint(3, 2000.0, 0.583126-refvalue_pg_pi);
    treenumber_pg_diff_pi->SetPoint(4, 2500.0, 0.597736-refvalue_pg_pi);
    ...
    treenumber_pg_diff_p->SetPoint(0, 500.0, 0.850267-refvalue_pg_p);
    treenumber_pg_diff_p->SetPoint(1, 1000.0, 0.845924-refvalue_pg_p);
    treenumber_pg_diff_p->SetPoint(2, 1500.0, 0.842328-refvalue_pg_p);
    treenumber_pg_diff_p->SetPoint(3, 2000.0, 0.837001-refvalue_pg_p);
    treenumber_pg_diff_p->SetPoint(4, 2500.0, 0.831826-refvalue_pg_p);
    ...
    treenumber_pg_diff_e->SetPoint(0, 500.0, 0.54774-refvalue_pg_e);
    treenumber_pg_diff_e->SetPoint(1, 1000.0, 0.549095-refvalue_pg_e);
    treenumber_pg_diff_e->SetPoint(2, 1500.0, 0.549714-refvalue_pg_e);
    treenumber_pg_diff_e->SetPoint(3, 2000.0, 0.550023-refvalue_pg_e);
    treenumber_pg_diff_e->SetPoint(4, 2500.0, 0.550288-refvalue_pg_e);
