{
    ...
    treenumber_pg_mu->SetPoint(0, 500.0, 0.968545-refvalue_pg_mu);
    treenumber_pg_mu->SetPoint(1, 1000.0, 0.963724-refvalue_pg_mu);
    treenumber_pg_mu->SetPoint(2, 1500.0, 0.955676-refvalue_pg_mu);
    treenumber_pg_mu->SetPoint(3, 2000.0, 0.946658-refvalue_pg_mu);
    treenumber_pg_mu->SetPoint(4, 2500.0, 0.939796-refvalue_pg_mu);
    ...
    treenumber_pg_pi->SetPoint(0, 500.0, 0.504641-refvalue_pg_pi);
    treenumber_pg_pi->SetPoint(1, 1000.0, 0.525485-refvalue_pg_pi);
    treenumber_pg_pi->SetPoint(2, 1500.0, 0.554236-refvalue_pg_pi);
    treenumber_pg_pi->SetPoint(3, 2000.0, 0.583126-refvalue_pg_pi);
    treenumber_pg_pi->SetPoint(4, 2500.0, 0.597736-refvalue_pg_pi);
    ...
    treenumber_pg_p->SetPoint(0, 500.0, 0.850267-refvalue_pg_p);
    treenumber_pg_p->SetPoint(1, 1000.0, 0.845924-refvalue_pg_p);
    treenumber_pg_p->SetPoint(2, 1500.0, 0.842328-refvalue_pg_p);
    treenumber_pg_p->SetPoint(3, 2000.0, 0.837001-refvalue_pg_p);
    treenumber_pg_p->SetPoint(4, 2500.0, 0.831826-refvalue_pg_p);
    ...
    treenumber_pg_e->SetPoint(0, 500.0, 0.54774-refvalue_pg_e);
    treenumber_pg_e->SetPoint(1, 1000.0, 0.549095-refvalue_pg_e);
    treenumber_pg_e->SetPoint(2, 1500.0, 0.549714-refvalue_pg_e);
    treenumber_pg_e->SetPoint(3, 2000.0, 0.550023-refvalue_pg_e);
    treenumber_pg_e->SetPoint(4, 2500.0, 0.550288-refvalue_pg_e);
    ...
    shrinkage_pg_mu->SetPoint(0, 0.01, 0.978113-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(1, 0.02, 0.978634-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(2, 0.04, 0.977983-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(3, 0.06, 0.977404-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(4, 0.08, 0.977129-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(5, 0.1, 0.978026-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(6, 0.3, 0.976897-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(7, 0.5, 0.974407-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(8, 0.7, 0.97474-refvalue_pg_mu);
    shrinkage_pg_mu->SetPoint(9, 0.9, 0.969167-refvalue_pg_mu);
    ...
    shrinkage_pg_pi->SetPoint(0, 0.01, 0.233243-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(1, 0.02, 0.323518-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(2, 0.04, 0.386835-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(3, 0.06, 0.413304-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(4, 0.08, 0.427079-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(5, 0.1, 0.422499-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(6, 0.3, 0.447923-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(7, 0.5, 0.468037-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(8, 0.7, 0.467009-refvalue_pg_pi);
    shrinkage_pg_pi->SetPoint(9, 0.9, 0.496334-refvalue_pg_pi);
    ...
    shrinkage_pg_p->SetPoint(0, 0.01, 0.732479-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(1, 0.02, 0.773382-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(2, 0.04, 0.802324-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(3, 0.06, 0.828807-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(4, 0.08, 0.848333-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(5, 0.1, 0.854203-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(6, 0.3, 0.860802-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(7, 0.5, 0.857002-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(8, 0.7, 0.856595-refvalue_pg_p);
    shrinkage_pg_p->SetPoint(9, 0.9, 0.848435-refvalue_pg_p);
    ...
    shrinkage_pg_e->SetPoint(0, 0.01, 0.527018-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(1, 0.02, 0.524455-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(2, 0.04, 0.527401-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(3, 0.06, 0.532718-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(4, 0.08, 0.538903-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(5, 0.1, 0.562762-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(6, 0.3, 0.545634-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(7, 0.5, 0.548226-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(8, 0.7, 0.548638-refvalue_pg_e);
    shrinkage_pg_e->SetPoint(9, 0.9, 0.548476-refvalue_pg_e);
    ...
    bagged_pg_mu->SetPoint(0, 0.1, 0.903795-refvalue_pg_mu);
    bagged_pg_mu->SetPoint(1, 0.3, 0.961394-refvalue_pg_mu);
    bagged_pg_mu->SetPoint(2, 0.5, 0.935135-refvalue_pg_mu);
    bagged_pg_mu->SetPoint(3, 0.7, 0.962552-refvalue_pg_mu);
    bagged_pg_mu->SetPoint(4, 0.9, 0.967184-refvalue_pg_mu);
    ...
    bagged_pg_pi->SetPoint(0, 0.1, 0.355089-refvalue_pg_pi);
    bagged_pg_pi->SetPoint(1, 0.3, 0.50438-refvalue_pg_pi);
    bagged_pg_pi->SetPoint(2, 0.5, 0.595699-refvalue_pg_pi);
    bagged_pg_pi->SetPoint(3, 0.7, 0.522334-refvalue_pg_pi);
    bagged_pg_pi->SetPoint(4, 0.9, 0.4998-refvalue_pg_pi);
    ...
    bagged_pg_p->SetPoint(0, 0.1, 0.84779-refvalue_pg_p);
    bagged_pg_p->SetPoint(1, 0.3, 0.848486-refvalue_pg_p);
    bagged_pg_p->SetPoint(2, 0.5, 0.850691-refvalue_pg_p);
    bagged_pg_p->SetPoint(3, 0.7, 0.858631-refvalue_pg_p);
    bagged_pg_p->SetPoint(4, 0.9, 0.862957-refvalue_pg_p);
    ...
    bagged_pg_e->SetPoint(0, 0.1, 0.517725-refvalue_pg_e);
    bagged_pg_e->SetPoint(1, 0.3, 0.548093-refvalue_pg_e);
    bagged_pg_e->SetPoint(2, 0.5, 0.547637-refvalue_pg_e);
    bagged_pg_e->SetPoint(3, 0.7, 0.547755-refvalue_pg_e);
    ...
    randomforests_pg_mu->SetPoint(0, 4, 0.95378-refvalue_pg_mu);
    randomforests_pg_mu->SetPoint(1, 6, 0.966808-refvalue_pg_mu);
    randomforests_pg_mu->SetPoint(2, 8, 0.969674-refvalue_pg_mu);
    randomforests_pg_mu->SetPoint(3, 10, 0.968603-refvalue_pg_mu);
    randomforests_pg_mu->SetPoint(4, 12, 0.969095-refvalue_pg_mu);
    ...
    randomforests_pg_pi->SetPoint(0, 4, 0.566687-refvalue_pg_pi);
    randomforests_pg_pi->SetPoint(1, 6, 0.515542-refvalue_pg_pi);
    randomforests_pg_pi->SetPoint(2, 8, 0.502098-refvalue_pg_pi);
    randomforests_pg_pi->SetPoint(3, 10, 0.501367-refvalue_pg_pi);
    randomforests_pg_pi->SetPoint(4, 12, 0.506469-refvalue_pg_pi);
    ...
    randomforests_pg_p->SetPoint(0, 4, 0.860497-refvalue_pg_p);
    randomforests_pg_p->SetPoint(1, 6, 0.858156-refvalue_pg_p);
    randomforests_pg_p->SetPoint(2, 8, 0.847926-refvalue_pg_p);
    randomforests_pg_p->SetPoint(3, 10, 0.85651-refvalue_pg_p);
    randomforests_pg_p->SetPoint(4, 12, 0.847587-refvalue_pg_p);
    ...
    randomforests_pg_e->SetPoint(0, 4, 0.550185-refvalue_pg_e);
    randomforests_pg_e->SetPoint(1, 6, 0.549242-refvalue_pg_e);
    randomforests_pg_e->SetPoint(2, 8, 0.548742-refvalue_pg_e);
    randomforests_pg_e->SetPoint(3, 10, 0.549095-refvalue_pg_e);
