{
    ...
    TPC2_musel_mu->Fill(tpc2varchoices[0],0.927858);
    TPC2_musel_pi->Fill(tpc2varchoices[0],0.333339); 
    TPC2_musel_p->Fill(tpc2varchoices[0],0.0208305);
    TPC2_musel_e->Fill(tpc2varchoices[0],0.0598515);
    TPC2_pisel_mu->Fill(tpc2varchoices[0],0.0625951);
    TPC2_pisel_pi->Fill(tpc2varchoices[0],0.624589);
    TPC2_pisel_p->Fill(tpc2varchoices[0],0.0520329);
    TPC2_pisel_e->Fill(tpc2varchoices[0],0.104068);
    TPC2_psel_mu->Fill(tpc2varchoices[0],0.00906839);
    TPC2_psel_pi->Fill(tpc2varchoices[0],0.040343);
    TPC2_psel_p->Fill(tpc2varchoices[0],0.916211);
    TPC2_psel_e->Fill(tpc2varchoices[0],0.18196);
    TPC2_esel_mu->Fill(tpc2varchoices[0],0.000478046);
    TPC2_esel_pi->Fill(tpc2varchoices[0],0.00172874);
    TPC2_esel_p->Fill(tpc2varchoices[0],0.0109252);
    TPC2_esel_e->Fill(tpc2varchoices[0],0.65412);
    ...
    TPC2_musel_mu->Fill(tpc2varchoices[2],0.925932);
    TPC2_musel_pi->Fill(tpc2varchoices[2],0.319252); 
    TPC2_musel_p->Fill(tpc2varchoices[2],0.0219195);
    TPC2_musel_e->Fill(tpc2varchoices[2],0.0334373);
    TPC2_pisel_mu->Fill(tpc2varchoices[2],0.0655937);
    TPC2_pisel_pi->Fill(tpc2varchoices[2],0.643503);
    TPC2_pisel_p->Fill(tpc2varchoices[2],0.0551445);
    TPC2_pisel_e->Fill(tpc2varchoices[2],0.114135);
    TPC2_psel_mu->Fill(tpc2varchoices[2],0.00799641);
    TPC2_psel_pi->Fill(tpc2varchoices[2],0.0343523);
    TPC2_psel_p->Fill(tpc2varchoices[2],0.913739);
    TPC2_psel_e->Fill(tpc2varchoices[2],0.185716);
    TPC2_esel_mu->Fill(tpc2varchoices[2],0.000478046);
    TPC2_esel_pi->Fill(tpc2varchoices[2],0.00289265);
    TPC2_esel_p->Fill(tpc2varchoices[2],0.00919652);
    TPC2_esel_e->Fill(tpc2varchoices[2],0.666711);
    ...
    TPC2_pisel_mu_diff->GetYaxis()->SetRangeUser(-0.035, 0.015);
