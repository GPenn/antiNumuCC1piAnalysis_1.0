{
    ...
    TPC3_musel_mu->Fill(tpc3varchoices[0],0.928192);
    TPC3_musel_pi->Fill(tpc3varchoices[0],0.321067); 
    TPC3_musel_p->Fill(tpc3varchoices[0],0.0200526);
    TPC3_musel_e->Fill(tpc3varchoices[0],0.0454343);
    TPC3_pisel_mu->Fill(tpc3varchoices[0],0.0640582);
    TPC3_pisel_pi->Fill(tpc3varchoices[0],0.650965);
    TPC3_pisel_p->Fill(tpc3varchoices[0],0.0427845);
    TPC3_pisel_e->Fill(tpc3varchoices[0],0.101544);
    TPC3_psel_mu->Fill(tpc3varchoices[0],0.00743144);
    TPC3_psel_pi->Fill(tpc3varchoices[0],0.0265987);
    TPC3_psel_p->Fill(tpc3varchoices[0],0.926186);
    TPC3_psel_e->Fill(tpc3varchoices[0],0.189859);
    TPC3_esel_mu->Fill(tpc3varchoices[0],0.000318697);
    TPC3_esel_pi->Fill(tpc3varchoices[0],0.0013693);
    TPC3_esel_p->Fill(tpc3varchoices[0],0.010977);
    TPC3_esel_e->Fill(tpc3varchoices[0],0.663163);
    
    TPC3_musel_mu->Fill(tpc3varchoices[1],0.952731);
    TPC3_musel_pi->Fill(tpc3varchoices[1],0.386434); 
    TPC3_musel_p->Fill(tpc3varchoices[1],0.0513587);
    TPC3_musel_e->Fill(tpc3varchoices[1],0.0677951);
    TPC3_pisel_mu->Fill(tpc3varchoices[1],0.0454723);
    TPC3_pisel_pi->Fill(tpc3varchoices[1],0.610605);
    TPC3_pisel_p->Fill(tpc3varchoices[1],0.136686);
    TPC3_pisel_e->Fill(tpc3varchoices[1],0.45513);
    TPC3_psel_mu->Fill(tpc3varchoices[1],0.00152106);
    TPC3_psel_pi->Fill(tpc3varchoices[1],0.00260167);
    TPC3_psel_p->Fill(tpc3varchoices[1],0.807305);
    TPC3_psel_e->Fill(tpc3varchoices[1],0.151359);
    TPC3_esel_mu->Fill(tpc3varchoices[1],0.000275239);
    TPC3_esel_pi->Fill(tpc3varchoices[1],0.000359441);
    TPC3_esel_p->Fill(tpc3varchoices[1],0.00465012);
    TPC3_esel_e->Fill(tpc3varchoices[1],0.325716);
    
    TPC3_musel_mu->Fill(tpc3varchoices[2],0.926584);
    TPC3_musel_pi->Fill(tpc3varchoices[2],0.320776); 
    TPC3_musel_p->Fill(tpc3varchoices[2],0.0191018);
    TPC3_musel_e->Fill(tpc3varchoices[2],0.012487);
    TPC3_pisel_mu->Fill(tpc3varchoices[2],0.0610595);
    TPC3_pisel_pi->Fill(tpc3varchoices[2],0.632617);
    TPC3_pisel_p->Fill(tpc3varchoices[2],0.0359736);
    TPC3_pisel_e->Fill(tpc3varchoices[2],0.0112101);
    TPC3_psel_mu->Fill(tpc3varchoices[2],0.00805435);
    TPC3_psel_pi->Fill(tpc3varchoices[2],0.0300904);
    TPC3_psel_p->Fill(tpc3varchoices[2],0.897369);
    TPC3_psel_e->Fill(tpc3varchoices[2],0.0373571);
    TPC3_esel_mu->Fill(tpc3varchoices[2],0.00430242);
    TPC3_esel_pi->Fill(tpc3varchoices[2],0.0165172);
    TPC3_esel_p->Fill(tpc3varchoices[2],0.0475557);
    TPC3_esel_e->Fill(tpc3varchoices[2],0.938946);
    
    TPC3_musel_mu->Fill(tpc3varchoices[3],0.915487);
    TPC3_musel_pi->Fill(tpc3varchoices[3],0.300305); 
    TPC3_musel_p->Fill(tpc3varchoices[3],0.0185486);
    TPC3_musel_e->Fill(tpc3varchoices[3],0.0102301);
    TPC3_pisel_mu->Fill(tpc3varchoices[3],0.0727499);
    TPC3_pisel_pi->Fill(tpc3varchoices[3],0.664864);
    TPC3_pisel_p->Fill(tpc3varchoices[3],0.050287);
    TPC3_pisel_e->Fill(tpc3varchoices[3],0.0139718);
    TPC3_psel_mu->Fill(tpc3varchoices[3],0.00618563);
    TPC3_psel_pi->Fill(tpc3varchoices[3],0.0173559);
    TPC3_psel_p->Fill(tpc3varchoices[3],0.872718);
    TPC3_psel_e->Fill(tpc3varchoices[3],0.035412);
    TPC3_esel_mu->Fill(tpc3varchoices[3],0.0055772);
    TPC3_esel_pi->Fill(tpc3varchoices[3],0.0174757);
    TPC3_esel_p->Fill(tpc3varchoices[3],0.0584463);
    TPC3_esel_e->Fill(tpc3varchoices[3],0.940386);
