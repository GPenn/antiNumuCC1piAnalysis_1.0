{
    ...
    TPC3_musel_mu->Fill(tpc3varchoices[0],0.92738);
    TPC3_musel_pi->Fill(tpc3varchoices[0],0.344259); 
    TPC3_musel_p->Fill(tpc3varchoices[0],0.0201908);
    TPC3_musel_e->Fill(tpc3varchoices[0],0.0453898);
    TPC3_pisel_mu->Fill(tpc3varchoices[0],0.0643479);
    TPC3_pisel_pi->Fill(tpc3varchoices[0],0.626951);
    TPC3_pisel_p->Fill(tpc3varchoices[0],0.0418511);
    TPC3_pisel_e->Fill(tpc3varchoices[0],0.0938233);
    TPC3_psel_mu->Fill(tpc3varchoices[0],0.00783706);
    TPC3_psel_pi->Fill(tpc3varchoices[0],0.0271806);
    TPC3_psel_p->Fill(tpc3varchoices[0],0.927794);
    TPC3_psel_e->Fill(tpc3varchoices[0],0.160653);
    TPC3_esel_mu->Fill(tpc3varchoices[0],0.000434587);
    TPC3_esel_pi->Fill(tpc3varchoices[0],0.00160893);
    TPC3_esel_p->Fill(tpc3varchoices[0],0.0101646);
    TPC3_esel_e->Fill(tpc3varchoices[0],0.700134);
    
    TPC3_musel_mu->Fill(tpc3varchoices[1],0.93642);
    TPC3_musel_pi->Fill(tpc3varchoices[1],0.369026); 
    TPC3_musel_p->Fill(tpc3varchoices[1],0.0277451);
    TPC3_musel_e->Fill(tpc3varchoices[1],0.0137936);
    TPC3_pisel_mu->Fill(tpc3varchoices[1],0.0525706);
    TPC3_pisel_pi->Fill(tpc3varchoices[1],0.587806);
    TPC3_pisel_p->Fill(tpc3varchoices[1],0.046311);
    TPC3_pisel_e->Fill(tpc3varchoices[1],0.00886414);
    TPC3_psel_mu->Fill(tpc3varchoices[1],0.00538888);
    TPC3_psel_pi->Fill(tpc3varchoices[1],0.0218746);
    TPC3_psel_p->Fill(tpc3varchoices[1],0.749793);
    TPC3_psel_e->Fill(tpc3varchoices[1],0.0403267);
    TPC3_esel_mu->Fill(tpc3varchoices[1],0.00562066);
    TPC3_esel_pi->Fill(tpc3varchoices[1],0.0212926);
    TPC3_esel_p->Fill(tpc3varchoices[1],0.176151);
    TPC3_esel_e->Fill(tpc3varchoices[1],0.937016);
    
    TPC3_musel_mu->Fill(tpc3varchoices[2],0.921079);
    TPC3_musel_pi->Fill(tpc3varchoices[2],0.34289); 
    TPC3_musel_p->Fill(tpc3varchoices[2],0.0259992);
    TPC3_musel_e->Fill(tpc3varchoices[2],0.0047513);
    TPC3_pisel_mu->Fill(tpc3varchoices[2],0.0624357);
    TPC3_pisel_pi->Fill(tpc3varchoices[2],0.600746);
    TPC3_pisel_p->Fill(tpc3varchoices[2],0.0462592);
    TPC3_pisel_e->Fill(tpc3varchoices[2],0.00289532);
    TPC3_psel_mu->Fill(tpc3varchoices[2],0.00606974);
    TPC3_psel_pi->Fill(tpc3varchoices[2],0.0188108);
    TPC3_psel_p->Fill(tpc3varchoices[2],0.831317);
    TPC3_psel_e->Fill(tpc3varchoices[2],0.0228359);
    TPC3_esel_mu->Fill(tpc3varchoices[2],0.0104156);
    TPC3_esel_pi->Fill(tpc3varchoices[2],0.0375531);
    TPC3_esel_p->Fill(tpc3varchoices[2],0.0964251);
    TPC3_esel_e->Fill(tpc3varchoices[2],0.969517);
    
    TPC3_musel_mu->Fill(tpc3varchoices[3],0.93881);
    TPC3_musel_pi->Fill(tpc3varchoices[3],0.342958); 
    TPC3_musel_p->Fill(tpc3varchoices[3],0.0251867);
    TPC3_musel_e->Fill(tpc3varchoices[3],0.01268);
    TPC3_pisel_mu->Fill(tpc3varchoices[3],0.0522809);
    TPC3_pisel_pi->Fill(tpc3varchoices[3],0.621063);
    TPC3_pisel_p->Fill(tpc3varchoices[3],0.0415053);
    TPC3_pisel_e->Fill(tpc3varchoices[3],0.0136154);
    TPC3_psel_mu->Fill(tpc3varchoices[3],0.00586693);
    TPC3_psel_pi->Fill(tpc3varchoices[3],0.0232439);
    TPC3_psel_p->Fill(tpc3varchoices[3],0.881275);
    TPC3_psel_e->Fill(tpc3varchoices[3],0.0324425);
    TPC3_esel_mu->Fill(tpc3varchoices[3],0.00304211);
    TPC3_esel_pi->Fill(tpc3varchoices[3],0.0127345);
    TPC3_esel_p->Fill(tpc3varchoices[3],0.0520329);
    TPC3_esel_e->Fill(tpc3varchoices[3],0.941262);
    ...
    TPC3_pisel_mu->GetYaxis()->SetRangeUser(0, 0.4);
    ...
    TPC3_musel_mu_diff->GetYaxis()->SetRangeUser(-0.2, 0.3);
    ...
    TPC3_pisel_mu_diff->GetYaxis()->SetRangeUser(-0.15, 0.2);
