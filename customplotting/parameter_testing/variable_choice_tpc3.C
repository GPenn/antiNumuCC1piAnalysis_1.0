{
    ...
    TPC3_musel_mu->Fill(tpc3varchoices[1],0.957845);
    TPC3_musel_pi->Fill(tpc3varchoices[1],0.400349); 
    TPC3_musel_p->Fill(tpc3varchoices[1],0.0572881);
    TPC3_musel_e->Fill(tpc3varchoices[1],0.0887157);
    TPC3_pisel_mu->Fill(tpc3varchoices[1],0.0404456);
    TPC3_pisel_pi->Fill(tpc3varchoices[1],0.596844);
    TPC3_pisel_p->Fill(tpc3varchoices[1],0.137464);
    TPC3_pisel_e->Fill(tpc3varchoices[1],0.376377);
    TPC3_psel_mu->Fill(tpc3varchoices[1],0.0014776);
    TPC3_psel_pi->Fill(tpc3varchoices[1],0.00246474);
    TPC3_psel_p->Fill(tpc3varchoices[1],0.799941);
    TPC3_psel_e->Fill(tpc3varchoices[1],0.130245);
    TPC3_esel_mu->Fill(tpc3varchoices[1],0.00023178);
    TPC3_esel_pi->Fill(tpc3varchoices[1],0.000342325);
    TPC3_esel_p->Fill(tpc3varchoices[1],0.00530701);
    TPC3_esel_e->Fill(tpc3varchoices[1],0.404662);
    
    TPC3_musel_mu->Fill(tpc3varchoices[2],0.928829);
    TPC3_musel_pi->Fill(tpc3varchoices[2],0.321837); 
    TPC3_musel_p->Fill(tpc3varchoices[2],0.0194994);
    TPC3_musel_e->Fill(tpc3varchoices[2],0.0137194);
    TPC3_pisel_mu->Fill(tpc3varchoices[2],0.0600165);
    TPC3_pisel_pi->Fill(tpc3varchoices[2],0.634636);
    TPC3_pisel_p->Fill(tpc3varchoices[2],0.0368206);
    TPC3_pisel_e->Fill(tpc3varchoices[2],0.0131849);
    TPC3_psel_mu->Fill(tpc3varchoices[2],0.00728658);
    TPC3_psel_pi->Fill(tpc3varchoices[2],0.0293201);
    TPC3_psel_p->Fill(tpc3varchoices[2],0.898458);
    TPC3_psel_e->Fill(tpc3varchoices[2],0.0406682);
    TPC3_esel_mu->Fill(tpc3varchoices[2],0.00386783);
    TPC3_esel_pi->Fill(tpc3varchoices[2],0.0142065);
    TPC3_esel_p->Fill(tpc3varchoices[2],0.045222);
    TPC3_esel_e->Fill(tpc3varchoices[2],0.932428);
    
    TPC3_musel_mu->Fill(tpc3varchoices[3],0.920079);
    TPC3_musel_pi->Fill(tpc3varchoices[3],0.307494); 
    TPC3_musel_p->Fill(tpc3varchoices[3],0.0198624);
    TPC3_musel_e->Fill(tpc3varchoices[3],0.0104529);
    TPC3_pisel_mu->Fill(tpc3varchoices[3],0.0686503);
    TPC3_pisel_pi->Fill(tpc3varchoices[3],0.658206);
    TPC3_pisel_p->Fill(tpc3varchoices[3],0.0524305);
    TPC3_pisel_e->Fill(tpc3varchoices[3],0.0141351);
    TPC3_psel_mu->Fill(tpc3varchoices[3],0.00560618);
    TPC3_psel_pi->Fill(tpc3varchoices[3],0.0167397);
    TPC3_psel_p->Fill(tpc3varchoices[3],0.874067);
    TPC3_psel_e->Fill(tpc3varchoices[3],0.0363177);
    TPC3_esel_mu->Fill(tpc3varchoices[3],0.00566412);
    TPC3_esel_pi->Fill(tpc3varchoices[3],0.0175613);
    TPC3_esel_p->Fill(tpc3varchoices[3],0.0536406);
    TPC3_esel_e->Fill(tpc3varchoices[3],0.939094);
