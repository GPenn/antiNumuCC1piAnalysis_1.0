{
    ...
    nminus1det_musel_mu_diff->Fill(nminus1detchoices[0], nminus1det_musel_mu->GetBinContent(1)-refvalue_musel_mu );
    nminus1det_musel_pi_diff->Fill(nminus1detchoices[0], nminus1det_musel_pi->GetBinContent(1)-refvalue_musel_pi ); 
    nminus1det_musel_p_diff->Fill(nminus1detchoices[0], nminus1det_musel_p->GetBinContent(1)-refvalue_musel_p );
    nminus1det_musel_e_diff->Fill(nminus1detchoices[0], nminus1det_musel_e->GetBinContent(1)-refvalue_musel_e );
    nminus1det_pisel_mu_diff->Fill(nminus1detchoices[0], nminus1det_pisel_mu->GetBinContent(1)-refvalue_pisel_mu );
    nminus1det_pisel_pi_diff->Fill(nminus1detchoices[0], nminus1det_pisel_pi->GetBinContent(1)-refvalue_pisel_pi );
    nminus1det_pisel_p_diff->Fill(nminus1detchoices[0], nminus1det_pisel_p->GetBinContent(1)-refvalue_pisel_p );
    nminus1det_pisel_e_diff->Fill(nminus1detchoices[0], nminus1det_pisel_e->GetBinContent(1)-refvalue_pisel_e );
    nminus1det_psel_mu_diff->Fill(nminus1detchoices[0], nminus1det_psel_mu->GetBinContent(1)-refvalue_psel_mu );
    nminus1det_psel_pi_diff->Fill(nminus1detchoices[0], nminus1det_psel_pi->GetBinContent(1)-refvalue_psel_pi );
    nminus1det_psel_p_diff->Fill(nminus1detchoices[0], nminus1det_psel_p->GetBinContent(1)-refvalue_psel_p );
    nminus1det_psel_e_diff->Fill(nminus1detchoices[0], nminus1det_psel_e->GetBinContent(1)-refvalue_psel_e );
    nminus1det_esel_mu_diff->Fill(nminus1detchoices[0], nminus1det_esel_mu->GetBinContent(1)-refvalue_esel_mu );
    nminus1det_esel_pi_diff->Fill(nminus1detchoices[0], nminus1det_esel_pi->GetBinContent(1)-refvalue_esel_pi );
    nminus1det_esel_p_diff->Fill(nminus1detchoices[0], nminus1det_esel_p->GetBinContent(1)-refvalue_esel_p );
    nminus1det_esel_e_diff->Fill(nminus1detchoices[0], nminus1det_esel_e->GetBinContent(1)-refvalue_esel_e );
    
    nminus1det_musel_mu_diff->Fill(nminus1detchoices[1], nminus1det_musel_mu->GetBinContent(2)-refvalue_musel_mu );
    nminus1det_musel_pi_diff->Fill(nminus1detchoices[1], nminus1det_musel_pi->GetBinContent(2)-refvalue_musel_pi ); 
    nminus1det_musel_p_diff->Fill(nminus1detchoices[1], nminus1det_musel_p->GetBinContent(2)-refvalue_musel_p );
    nminus1det_musel_e_diff->Fill(nminus1detchoices[1], nminus1det_musel_e->GetBinContent(2)-refvalue_musel_e );
    nminus1det_pisel_mu_diff->Fill(nminus1detchoices[1], nminus1det_pisel_mu->GetBinContent(2)-refvalue_pisel_mu );
    nminus1det_pisel_pi_diff->Fill(nminus1detchoices[1], nminus1det_pisel_pi->GetBinContent(2)-refvalue_pisel_pi );
    nminus1det_pisel_p_diff->Fill(nminus1detchoices[1], nminus1det_pisel_p->GetBinContent(2)-refvalue_pisel_p );
    nminus1det_pisel_e_diff->Fill(nminus1detchoices[1], nminus1det_pisel_e->GetBinContent(2)-refvalue_pisel_e    );
    nminus1det_psel_mu_diff->Fill(nminus1detchoices[1], nminus1det_psel_mu->GetBinContent(2)-refvalue_psel_mu );
    nminus1det_psel_pi_diff->Fill(nminus1detchoices[1], nminus1det_psel_pi->GetBinContent(2)-refvalue_psel_pi );
    nminus1det_psel_p_diff->Fill(nminus1detchoices[1], nminus1det_psel_p->GetBinContent(2)-refvalue_psel_p );
    nminus1det_psel_e_diff->Fill(nminus1detchoices[1], nminus1det_psel_e->GetBinContent(2)-refvalue_psel_e );
    nminus1det_esel_mu_diff->Fill(nminus1detchoices[1], nminus1det_esel_mu->GetBinContent(2)-refvalue_esel_mu );
    nminus1det_esel_pi_diff->Fill(nminus1detchoices[1], nminus1det_esel_pi->GetBinContent(2)-refvalue_esel_pi );
    nminus1det_esel_p_diff->Fill(nminus1detchoices[1], nminus1det_esel_p->GetBinContent(2)-refvalue_esel_p );
    nminus1det_esel_e_diff->Fill(nminus1detchoices[1], nminus1det_esel_e->GetBinContent(2)-refvalue_esel_e );
    
    nminus1det_musel_mu_diff->Fill(nminus1detchoices[2], nminus1det_musel_mu->GetBinContent(3)-refvalue_musel_mu );
    nminus1det_musel_pi_diff->Fill(nminus1detchoices[2], nminus1det_musel_pi->GetBinContent(3)-refvalue_musel_pi ); 
    nminus1det_musel_p_diff->Fill(nminus1detchoices[2], nminus1det_musel_p->GetBinContent(3)-refvalue_musel_p );
    nminus1det_musel_e_diff->Fill(nminus1detchoices[2], nminus1det_musel_e->GetBinContent(3)-refvalue_musel_e );
    nminus1det_pisel_mu_diff->Fill(nminus1detchoices[2], nminus1det_pisel_mu->GetBinContent(3)-refvalue_pisel_mu );
    nminus1det_pisel_pi_diff->Fill(nminus1detchoices[2], nminus1det_pisel_pi->GetBinContent(3)-refvalue_pisel_pi );
    nminus1det_pisel_p_diff->Fill(nminus1detchoices[2], nminus1det_pisel_p->GetBinContent(3)-refvalue_pisel_p );
    nminus1det_pisel_e_diff->Fill(nminus1detchoices[2], nminus1det_pisel_e->GetBinContent(3)-refvalue_pisel_e );
    nminus1det_psel_mu_diff->Fill(nminus1detchoices[2], nminus1det_psel_mu->GetBinContent(3)-refvalue_psel_mu );
    nminus1det_psel_pi_diff->Fill(nminus1detchoices[2], nminus1det_psel_pi->GetBinContent(3)-refvalue_psel_pi );
    nminus1det_psel_p_diff->Fill(nminus1detchoices[2], nminus1det_psel_p->GetBinContent(3)-refvalue_psel_p );
    nminus1det_psel_e_diff->Fill(nminus1detchoices[2], nminus1det_psel_e->GetBinContent(3)-refvalue_psel_e );
    nminus1det_esel_mu_diff->Fill(nminus1detchoices[2], nminus1det_esel_mu->GetBinContent(3)-refvalue_esel_mu );
    nminus1det_esel_pi_diff->Fill(nminus1detchoices[2], nminus1det_esel_pi->GetBinContent(3)-refvalue_esel_pi );
    nminus1det_esel_p_diff->Fill(nminus1detchoices[2], nminus1det_esel_p->GetBinContent(3)-refvalue_esel_p );
    nminus1det_esel_e_diff->Fill(nminus1detchoices[2], nminus1det_esel_e->GetBinContent(3)-refvalue_esel_e );
    
    nminus1det_musel_mu_diff->Fill(nminus1detchoices[3], nminus1det_musel_mu->GetBinContent(4)-refvalue_musel_mu );
    nminus1det_musel_pi_diff->Fill(nminus1detchoices[3], nminus1det_musel_pi->GetBinContent(4)-refvalue_musel_pi ); 
    nminus1det_musel_p_diff->Fill(nminus1detchoices[3], nminus1det_musel_p->GetBinContent(4)-refvalue_musel_p );
    nminus1det_musel_e_diff->Fill(nminus1detchoices[3], nminus1det_musel_e->GetBinContent(4)-refvalue_musel_e );
    nminus1det_pisel_mu_diff->Fill(nminus1detchoices[3], nminus1det_pisel_mu->GetBinContent(4)-refvalue_pisel_mu );
    nminus1det_pisel_pi_diff->Fill(nminus1detchoices[3], nminus1det_pisel_pi->GetBinContent(4)-refvalue_pisel_pi );
    nminus1det_pisel_p_diff->Fill(nminus1detchoices[3], nminus1det_pisel_p->GetBinContent(4)-refvalue_pisel_p );
    nminus1det_pisel_e_diff->Fill(nminus1detchoices[3], nminus1det_pisel_e->GetBinContent(4)-refvalue_pisel_e );
    nminus1det_psel_mu_diff->Fill(nminus1detchoices[3], nminus1det_psel_mu->GetBinContent(4)-refvalue_psel_mu );
    nminus1det_psel_pi_diff->Fill(nminus1detchoices[3], nminus1det_psel_pi->GetBinContent(4)-refvalue_psel_pi );
    nminus1det_psel_p_diff->Fill(nminus1detchoices[3], nminus1det_psel_p->GetBinContent(4)-refvalue_psel_p );
    nminus1det_psel_e_diff->Fill(nminus1detchoices[3], nminus1det_psel_e->GetBinContent(4)-refvalue_psel_e );
    nminus1det_esel_mu_diff->Fill(nminus1detchoices[3], nminus1det_esel_mu->GetBinContent(4)-refvalue_esel_mu );
    nminus1det_esel_pi_diff->Fill(nminus1detchoices[3], nminus1det_esel_pi->GetBinContent(4)-refvalue_esel_pi );
    nminus1det_esel_p_diff->Fill(nminus1detchoices[3], nminus1det_esel_p->GetBinContent(4)-refvalue_esel_p );
    nminus1det_esel_e_diff->Fill(nminus1detchoices[3], nminus1det_esel_e->GetBinContent(4)-refvalue_esel_e );
