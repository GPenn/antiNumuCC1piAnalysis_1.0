{
    ...
    treedepth_cc1pi_mu->SetTitle("Mu-like (CC1pi);Maximum tree depth;Optimal selection significance;");
    ...
    treedepth_cc1pi_pi->SetTitle("Pi-like (CC1pi) ;Maximum tree depth;Optimal selection significance;");
