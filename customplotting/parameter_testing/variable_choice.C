{
    ...
    nminus1_pg_mu->Fill(nminus1varchoices[8],218.982/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[9],216.783/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[10],215.513/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[11],216.886/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[12],217.112/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[13],217.282/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[14],216.72/refvalue_pg_mu);
    nminus1_pg_mu->Fill(nminus1varchoices[15],215.32/refvalue_pg_mu);
    ...
    nminus1_pg_pi->Fill(nminus1varchoices[8],173.86/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[9],162.441/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[10],162.471/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[11],162.1/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[12],162.814/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[13],161.54/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[14],161.566/refvalue_pg_pi);
    nminus1_pg_pi->Fill(nminus1varchoices[15],162.186/refvalue_pg_pi);
    ...
    nminus1_pg_p->Fill(nminus1varchoices[8],216.782/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[9],204.324/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[10],201.988/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[11],204.329/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[12],205.953/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[13],203.829/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[14],204.326/refvalue_pg_p);
    nminus1_pg_p->Fill(nminus1varchoices[15],204.906/refvalue_pg_p);
    ...
    nminus1_pg_e->Fill(nminus1varchoices[8],241.307/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[9],233.692/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[10],234.88/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[11],234.079/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[12],234.087/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[13],232.997/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[14],233.894/refvalue_pg_e);
    nminus1_pg_e->Fill(nminus1varchoices[15],234.148/refvalue_pg_e);
    ...
    nminus1_cc1pi_mu->Fill(nminus1varchoices[8],34.5206/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[9],34.511/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[10],34.2904/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[11],34.3347/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[12],34.3508/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[13],34.5029/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[14],34.3894/refvalue_cc1pi_mu);
    nminus1_cc1pi_mu->Fill(nminus1varchoices[15],34.3198/refvalue_cc1pi_mu);
    ...
    nminus1_cc1pi_pi->Fill(nminus1varchoices[8],39.2842/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[9],39.5661/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[10],39.6219/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[11],39.2113/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[12],39.5754/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[13],39.6465/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[14],39.5392/refvalue_cc1pi_pi);
    nminus1_cc1pi_pi->Fill(nminus1varchoices[15],39.2564/refvalue_cc1pi_pi);
