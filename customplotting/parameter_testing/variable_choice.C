{
    ...
    TPC2_cc1pi_mu->SetBarOffset(bar_offset + (bar_width*0));
    ...
    TPC2_cc1pi_pi->SetBarOffset(bar_offset + (bar_width*1));
    ...
    TPC2_pg_mu->SetBarOffset(bar_offset + (bar_width*2));
    ...
    TPC2_pg_pi->SetBarOffset(bar_offset + (bar_width*3));
    ...
    TPC2_pg_p->SetBarOffset(bar_offset + (bar_width*4));
