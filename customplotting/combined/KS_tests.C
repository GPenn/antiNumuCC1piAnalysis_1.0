{
    TFile *file_trainingsample = new TFile("../particle_gun/output/ks_trainingsample.root.root");
    ...
    TFile *file_testingsample = new TFile("../particle_gun/output/ks_testingsample.root.root");
